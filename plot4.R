...
plot(pwr_consumption2$DateAndTime,pwr_consumption2$Voltage, type="l", xlab="datetime",
     ylab="Voltage")
...
plot(pwr_consumption2$DateAndTime,pwr_consumption2$Global_reactive_power, type="l", xlab="datetime",
